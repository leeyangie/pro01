				...
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td>
								<textarea name="contents" id="contents" rows="8" cols="80" class="form-control">${noti.contents }</textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="author" id="author" class="form-control" value="${noti.author }" disabled>
							</td>
						</tr>
						<tr>
